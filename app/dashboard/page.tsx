...
const files = [
  ...
  { name: "Notes.pdf", type: "pdf", size: "52 MB", date: "Jun 30", protected: true },
  { name: "Overview.docx", type: "docx", size: "52 GB", date: "Mar 30", protected: true },
  { name: "Budget..pdf", type: "pdf", size: "52 GB", date: "Jan 8", protected: true },
  { name: "Summary.pdf", type: "pdf", size: "50 MB", date: "Jan 30", protected: true },
  { name: "Contract.pdf", type: "pdf", size: "52 GB", date: "Jun 30", protected: true },
  { name: "Contract.pdf", type: "pdf", size: "52 GB", date: "Jan 8", protected: true },
];
      ...
      <main className="flex-1 p-10">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-2">
            <button className="border px-4 py-2 rounded-lg font-medium text-gray-700">List View</button>
            <button className="bg-[#2156F7] text-white px-4 py-2 rounded-lg font-medium">Grid View</button>
            <button className="ml-2 border px-3 py-2 rounded-lg text-xl font-bold">+</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          {files.map((file, i) => {
            console.log(`🔍 Rendering file ${i}:`, file);
            return (
